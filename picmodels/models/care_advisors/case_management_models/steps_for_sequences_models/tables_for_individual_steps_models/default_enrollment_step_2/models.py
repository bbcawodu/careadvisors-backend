...
class DefaultEnrollmentStep2(models.Model):
    ...
    def return_values_dict(self):
        ...
        return values_dict
DefaultEnrollmentStep2.create_row_w_validated_params = classmethod(create_row_w_validated_params)
DefaultEnrollmentStep2.update_row_w_validated_params = classmethod(update_row_w_validated_params)
DefaultEnrollmentStep2.delete_row_w_validated_params = classmethod(delete_row_w_validated_params)
DefaultEnrollmentStep2.get_serialized_rows_by_id = classmethod(get_serialized_rows_by_id)
