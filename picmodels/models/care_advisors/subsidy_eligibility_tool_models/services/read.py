...
def retrieve_healthcare_subsidy_eligibility_data_by_id(cls, rqst_healthcare_subsidy_eligibility_data_id, list_of_ids, rqst_errors):
...
def retrieve_healthcare_subsidy_eligibility_data_by_family_size(cls, list_of_family_sizes, rqst_errors):
    healthcare_subsidy_eligibility_data_objs = filter_healthcare_subsidy_eligibility_data_instances_by_family_size(
        cls.objects.all(),
