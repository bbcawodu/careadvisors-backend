## CPS Metrics Submission Table Enpoints Documentation

#### CPS Metrics Submission table create, update, and delete endpoint.
To create, update, or delete rows of the CPSMetricsSubmission table in the database, make a PUT request to: http://picbackend.herokuapp.com/cps/v1/metrics/. 
...
"id": Integer(Required when "Database Action" == "Instance Deletion"),
}
```
...
#### CPS Metrics Submission table read endpoint.
- To read rows from the CPSMetricsSubmission table in the database, make a GET request to: http://picbackend.herokuapp.com/cps/v1/metrics/. 
