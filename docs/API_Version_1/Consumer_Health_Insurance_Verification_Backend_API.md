...
- To retrieve parsed trading partner data from pokitdok, submit a GET request to http://picbackend.herokuapp.com/v1/tradingpartners/ with the following optional parameter: "partnerid"
...
- To retrieve parsed eligibility data from pokitdok for a consumer, submit a POST request to http://picbackend.herokuapp.com/v1/eligibility/. The body of the request should be a JSON document using the following template:
