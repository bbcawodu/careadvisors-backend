...
class ConsumerMetricsManagementView(JSONPUTRspMixin, JSONGETRspMixin, View):
        ...
        if not rqst_errors:
            if rqst_action:
                if rqst_action == "delete":
                    MetricsSubmission.delete_row_w_validated_params(validated_put_rqst_params, rqst_errors)

                    if not rqst_errors:
                        response_raw_data['Data']["row"] = "Deleted"
            else:
                metrics_instance, metrics_instance_message = MetricsSubmission.create_or_update_row_w_validated_params(
                ...
                if not rqst_errors:
                    if metrics_instance and metrics_instance_message:
                        response_raw_data['Data']["row"] = metrics_instance.return_values_dict()
    ...
    def metrics_management_get_logic(self, request, validated_GET_rqst_params, response_raw_data, rqst_errors):
        ...
        if not rqst_errors:
            data_list, missing_primary_parameters = retrieve_metrics_data_by_request_params(
...
def retrieve_metrics_data_by_request_params(validated_GET_rqst_params, validated_fields, rqst_errors):
    ...
    if 'id' in validated_GET_rqst_params:
        ...
        data_list, missing_primary_parameters = MetricsSubmission.retrieve_metrics_data_by_staff_id(
            rqst_staff_id,
            list_of_ids,
            validated_GET_rqst_params,
            rqst_errors,
        ...
        data_list, missing_primary_parameters = MetricsSubmission.retrieve_metrics_data_by_staff_f_and_l_name(
            list_of_first_names,
            list_of_last_names,
            validated_GET_rqst_params,
            rqst_errors,
        ...
        data_list, missing_primary_parameters = MetricsSubmission.retrieve_metrics_data_by_staff_first_name(
            list_of_first_names,
            validated_GET_rqst_params,
            rqst_errors,
            fields=validated_fields
        ...
        data_list, missing_primary_parameters = MetricsSubmission.retrieve_metrics_data_by_staff_last_name(
            list_of_last_names,
            validated_GET_rqst_params,
            rqst_errors,
            fields=validated_fields
        ...
        data_list, missing_primary_parameters = MetricsSubmission.retrieve_metrics_data_by_staff_email(
            list_of_emails,
            validated_GET_rqst_params,
            rqst_errors,
            fields=validated_fields
        ...
        data_list, missing_primary_parameters = MetricsSubmission.retrieve_metrics_data_by_staff_mpn(
            list_of_mpns,
            validated_GET_rqst_params,
            rqst_errors,
            fields=validated_fields
