...
def validate_metrics_put_rqst_params(rqst_body, rqst_errors):
    validated_params = {
    ...
    if rqst_action == 'create':
        validate_add_metrics_params(rqst_body, validated_params, rqst_errors)
    elif rqst_action == 'update':
        validated_params['rqst_metrics_id'] = clean_int_value_from_dict_object(rqst_body, "root", "id", rqst_errors)
        validate_update_metrics_params(rqst_body, validated_params, rqst_errors)
...
def validate_add_metrics_params(rqst_body, validated_params, rqst_errors):
...
def validate_update_metrics_params(rqst_body, validated_params, rqst_errors):
    consumer_metrics = clean_dict_value_from_dict_object(rqst_body, "root", "Consumer Metrics", rqst_errors)
    if not consumer_metrics:
        consumer_metrics = {}
